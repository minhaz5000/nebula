...
private:
    ...
    void resetState(); // Reset the state of the mouse

    
    void updatePosition(double xpos, double ypos);      // Update mouse position
    ...
    static void staticInputCallbackCorrection();
...
public:
    ...
    static Input * Get();                       // Get Input instance

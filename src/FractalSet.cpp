 ...
 * Set constructor
 */
FractalSet::FractalSet(int w, int h, char t) : Fractal::Fractal(w, h, t) {
 ...
 */
void FractalSet::findPixel(int x, int y, ComplexNumber c) {
 ...
 */
ComplexNumber FractalSet::iterate(ComplexNumber z, ComplexNumber c) {
	switch (getType()) {
	case 'm':
 ...
 */
void FractalSet::recalculateSet() {
